          ...
          {localDbEnabled ? (
            ...
            <div className="space-y-5">
              ...
              <Button
                ...
                disabled={loading}
                className="w-full py-6 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-905 dark:text-white font-semibold text-xs flex items-center justify-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-all shadow-sm"
              >
