...
### <a id="keys-and-encryption"></a>🔑 Keys and Encryption
...
## <a id="key-components"></a>🛠️ Key Components
...
## <a id="database-schema-and-multitenancy"></a>🗄️ Database Schema and Multitenancy
...
### <a id="1-local-sqlite-context-single-user-mode"></a>🗄️ 1. Local SQLite Context (Single User Mode)
...
### <a id="2-cloud-mongodb-context-multi-tenant-mode"></a>☁️ 2. Cloud MongoDB Context (Multi-Tenant Mode)
...
## <a id="upstream-provider-adapters"></a>🔌 Upstream Provider Adapters
...
### <a id="keep-alive-cron-pinger"></a>⏱️ Keep-Alive Cron Pinger
* **Symptom**: Cloud platform hosts (like Render) sleep after inactive periods.
* **Solution**: Enable a cron pinger target against `/api/cron-health` to receive uptime stats every 2 minutes.

### <a id="decryption-failures"></a>🔓 Decryption Failures
...
### <a id="port-conflicts"></a>🔌 Port Conflicts
